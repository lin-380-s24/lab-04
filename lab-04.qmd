...
- **Track changes:** Git records all changes made to files, so researchers can see what was done and go back if needed.

- **Work Together:** GitHub lets researchers share their work with others, so they can all contribute and improve it together.

- **Write Notes:**  Both Git and GitHub have features for adding notes and explanations, helping researchers explain their work clearly.

- **Fix Problems:**  GitHub helps find and fix any issues or mistakes in the research, ensuring it's reliable.

- **Share with Everyone:** Researchers can use GitHub to share their work openly, making it accessible to anyone who wants to see or use it.
